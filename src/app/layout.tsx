...
export const metadata: Metadata = {
  ...
  description:
    "Experience authentic cuisine at Logic Restaurant. We offer fine dining, private events, and exceptional catering services. Book your table today!",
  openGraph: {
    type: "website",
    url: siteUrl,
    title: "Logic Restaurant | Authentic Cuisine & Fine Dining",
    description:
      "Book your table for an unforgettable fine dining experience.",
    images: [
      {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      {/* Apply both Inter and Playfair fonts globally */}
